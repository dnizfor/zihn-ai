...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "batteryOptimizationBody": MessageLookupByLibrary.simpleMessage(
      "如果您遇到通知显示问题，请点击下面的按钮进入电池优化菜单。选择Zihn AI，如果选择了\'已优化\'，请将其更改为\'未优化\'或\'无限制\'。",
    ),
    "bePremiumSnackbarMessage": MessageLookupByLibrary.simpleMessage(
      "升级到高级版即可解锁此超棒功能！",
    ),
    "bePremiumSnackbarTitle": MessageLookupByLibrary.simpleMessage("升级到高级版！"),
    "bePremiumToastification": MessageLookupByLibrary.simpleMessage(
      "您当前正在使用基础版。升级到高级版即可获得更快、更准确的AI回答！",
    ),
    ...
    "fourthBenefitTitle": MessageLookupByLibrary.simpleMessage("激励通知"),
    ...
    "onboardingHomeDoctorBody": MessageLookupByLibrary.simpleMessage(
      "我们的程序由医疗专业人士设计和审核，确保您的健康。",
    ),
    "onboardingHomeDoctorTitle": MessageLookupByLibrary.simpleMessage("由医生设计"),
    ...
    "onboardingNameTitle": MessageLookupByLibrary.simpleMessage("您的名字是什么？"),
    "onboardingReminderSubtitle": MessageLookupByLibrary.simpleMessage(
      "我们将在您指定的时间发送提醒，以确保您的日常治疗过程不受干扰。",
    ),
    "onboardingReminderTitle": MessageLookupByLibrary.simpleMessage("设置治疗提醒"),
    "payNowTitle": MessageLookupByLibrary.simpleMessage("立即体验"),
    "paywallTitle": MessageLookupByLibrary.simpleMessage("获得高级特权"),
    "rateUsButtonTitle": MessageLookupByLibrary.simpleMessage("给我们评分！"),
    "reminderButtonTitle": MessageLookupByLibrary.simpleMessage("启用治疗提醒"),
    "reminderNotificationBody": MessageLookupByLibrary.simpleMessage(
      "现在是与您的心理学家交谈的时间！分享您的感受，放松心情。🌸",
    ),
    ...
    "topicCardToughDays": MessageLookupByLibrary.simpleMessage("艰难的日子"),
