...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "batteryOptimizationBody": MessageLookupByLibrary.simpleMessage(
      "Si vous rencontrez des problèmes d\'affichage des notifications, cliquez sur le bouton ci-dessous pour accéder au menu d\'optimisation de la batterie. Sélectionnez Zihn AI, et si \'Optimisé\' est sélectionné, changez-le en \'Non optimisé\' ou \'Aucune restriction\'.",
    ),
    ...
    "onboardingHomeAffirmationBody": MessageLookupByLibrary.simpleMessage(
      "Recevez des affirmations positives adaptées à vos émotions.",
    ),
    ...
    "onboardingHomeDoctorBody": MessageLookupByLibrary.simpleMessage(
      "Notre programme a été créé et validé par des professionnels de santé.",
    ),
    ...
    "onboardingHomeTherapyBody": MessageLookupByLibrary.simpleMessage(
      "Votre compagnon de bien-être personnel alimenté par l\'IA.",
    ),
    "onboardingHomeTherapyTitle": MessageLookupByLibrary.simpleMessage(
      "Bienvenue à la thérapie IA !",
    ),
    "onboardingNameSubtitle": MessageLookupByLibrary.simpleMessage(
      "Veuillez entrer votre nom afin que nous puissions vous appeler correctement.",
    ),
    ...
    "reminderNotificationBody": MessageLookupByLibrary.simpleMessage(
      "Il est temps de parler avec votre psychologue ! Partagez vos émotions et détendez-vous. 🌸",
    ),
